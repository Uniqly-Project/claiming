...
contract UniqlyClaimingByAdmin is Ownable{
    ...
    function claimByAdmin(
        ...
        require(token.ownerOf(_tokenId) == _claimer, "Claimer needs to own this token");
        ...
        require(_tryToSetNewName(_claimer, _claimersName));
    ...
    function setContractAtributes(address _address, bool _enable, uint _claimingPrice, uint _changeOwnerPrice, bool _isBurnble) external onlyOwner{
